...
ViberClient.prototype.sendMessage = function(optionalReceiver, messageType, messageData, optionalTrackingData, optionalKeyboard, optionalChatId, optionalMinApiVersion, optionalSender) {
	...
	if (optionalSender !== undefined) {
		sender.name = optionalSender.name,
		sender.avatar = optionalSender.avatar;
	}
